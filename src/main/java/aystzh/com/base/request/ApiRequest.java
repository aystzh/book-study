...
public class ApiRequest implements Serializable {
    ...
    public ApiRequest filterMultiMatchWithWeight(Map<String,Float> weightMap, Object value) {
        ApiRequestFilter filter = new ApiRequestFilter(OperatorType.MULTI_MATCH_WITH_WEIGHT, weightMap, value);
        if (filterList == null) {
            filterList = new ArrayList<>();
        }
        this.filterList.add(filter);
    ...
    public ApiRequest filterMatch(String field, Object value) {
        return this.filter(OperatorType.MATCH, field, value);
    }
    ...
    public ApiRequest addHighLightField(String field) {
        if (esHighLightSettings == null) {
            esHighLightSettings = Lists.newArrayList();
        }
        EsHighLightSetting esHighLightSetting = new EsHighLightSetting(field);
        esHighLightSettings.add(esHighLightSetting);
        return this;
    }

    public ApiRequest addHighLightField(String field, String preTag, String postTag) {
        if (esHighLightSettings == null) {
            esHighLightSettings = Lists.newArrayList();
        }
        EsHighLightSetting esHighLightSetting = new EsHighLightSetting(field, preTag, postTag);
        esHighLightSettings.add(esHighLightSetting);
        return this;
    }

    public List<EsHighLightSetting> getEsHighLightSettings() {
        return esHighLightSettings;
    }
}