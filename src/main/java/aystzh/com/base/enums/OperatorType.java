...
public enum OperatorType {
    ...
    CASCADE(18,"CASCADE"),
    MULTI_MATCH_WITH_WEIGHT(19, "MULTI_MATCH_WITH_WEIGHT"),
    MATCH(20,"MATCH")
    ;
    ...
    static {
        synchronized (_LOCK) {
            ...
            _UNARY_SET = Sets.newHashSet(EQ, LE, GE, LT, GT, LIKE,NOEQ,NOTNULL,ISNULL, LIKE_PREFIX, LIKE_SUBFIX,MATCH);
            _BINARY_SET = Sets.newHashSet(BETWEEN);
            _COLLECTION_SET = Sets.newHashSet(IN,NOTIN,OR,AND,LIKES);
            _MULTI_MATCH_SET = Sets.newHashSet(MULTI_MATCH,MULTI_MATCH_WITH_WEIGHT);
        }
    }
