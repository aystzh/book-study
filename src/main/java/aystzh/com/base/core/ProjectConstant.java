...
public final class ProjectConstant {
    ...
    public static final String MODEL_PACKAGE = BASE_PACKAGE + ".entity.tmp";//生成的Model所在包
    public static final String MAPPER_PACKAGE = BASE_PACKAGE + ".dao";//生成的Mapper所在包 生成完之后记得还原 项目启动的时候会扫描
    ...
    public static final String CONTROLLER_PACKAGE = BASE_PACKAGE + ".controller.tmp";//生成的Controller所在包
