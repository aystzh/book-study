...
import static aystzh.com.base.core.ProjectConstant.*;
...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/study?useUnicode=true&characterEncoding=utf8&useSSL=false";
    ...
    private static final String AUTHOR = "zhanghuan";//@author
    private static final String DATE = new SimpleDateFormat("yyyy/MM/dd").format(new Date());//@date

    public static void main(String[] args) {
        genCode("sys_admin_permission", "sys_resource_category", "sys_role_permission", "sys_role_resource");
